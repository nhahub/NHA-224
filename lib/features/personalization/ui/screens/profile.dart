                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        ...
                        child:  CircleAvatar(
                          radius: 50,
                          backgroundImage:  state is PersonalizationLoaded? NetworkImage(state.imageUrl): state is PersonalizationSuccess? NetworkImage(state.imageUrl): NetworkImage("https://imgs.search.brave.com/r8_rpLtbGMxU9_hP_eV66IWtpYYaUuj62TaONvbGyA8/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly91cy4x/MjNyZi5jb20vNDUw/d20vYmxpbmtibGlu/azEvYmxpbmtibGlu/azEyMDA1L2JsaW5r/YmxpbmsxMjAwNTAw/MDE1LzE0Njk3OTQ2/NC1hdmF0YXItbWFu/bi1zeW1ib2wuanBn/P3Zlcj02")
                        ),
                      ),
                    ],
                  ),
